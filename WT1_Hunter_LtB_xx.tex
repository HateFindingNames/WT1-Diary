...
\renewcommand{\thefigure}{\eintrag.\arabic{figure}}

\newcommand{\eintrag}{5} % nummer des eintrags

\newcommand{\titelLV}{Werkstofftechnik 1} % titel der LV

\newcommand{\dateofLV}{28. Mai 2020} % datum der LV
\newcommand{\deadline}{4. Juni 2020} % datum der abgabe
...
%\newcommand{\datum}{}
\usepackage{microtype} % reduziert die anzahl der silbentrennungen
